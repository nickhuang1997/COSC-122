...
# The dictionary is a simple python list of words
# The spellcheck_with_list function will simply use
# the raw dicionary to do it's checking
...
#---------------------------------------------------------------------
#check_time = spellcheck_with_hashtable(document, dictionary, 'Chaining', 1100)
